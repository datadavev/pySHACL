...
class Validator(object):
    ...
    @classmethod
    def create_validation_report(cls, sg, conforms: bool, results: List[Tuple], usage_info=None):
    ...
    def run(self):
        ...
        v_report, v_text = self.create_validation_report(self.shacl_graph, not non_conformant, reports, usage_info=usage)
